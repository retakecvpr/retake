...
def _get_image(image_url: str) -> Image:
...
def _process_request(
        ...
        if message.role == Role.ASSISTANT and isinstance(message.tool_calls, list) and len(message.tool_calls):
            ...
            for input_item in message.content:
                if input_item.type == "text":
                    ...
                    if isinstance(input_item.video_url, list):
                        video = [_get_image(image_item.url) for image_item in input_item.video_url]
                    else:
                        video = input_item.video_url.url
                else:
    ...
    return input_messages, system, tools, image, video
...
async def create_chat_completion_response(
    ...
    input_messages, system, tools, image, video = _process_request(request)
