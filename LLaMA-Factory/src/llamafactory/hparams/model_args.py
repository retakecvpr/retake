...
class ProcessorArguments:
    ...
    video_frame_extraction_fps: bool = field(
        default=5.0,
        metadata={"help": "The frames extracted per second for video inputs."},
    )
...
class ModelArguments(QuantizationArguments, ProcessorArguments, ExportArguments, VllmArguments):
    ...
    longvideo_kwargs: Optional[dict] = field(
        default=None,
        metadata={"help": "Additional arguments on long video understanding"},
    )
