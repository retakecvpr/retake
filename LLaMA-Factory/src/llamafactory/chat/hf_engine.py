...
class HuggingfaceEngine(BaseEngine):
    ...
    def _process_args(
        ...
        if image is not None:
            ...
            messages[0]["content"] = messages[0]["content"].replace("<|vision_start|><|image_pad|><|vision_end|>", "<video>")
        ...
        if video is not None:
            ...
            # NOTE: QWen2-VL visual tokens is not "<video>"
            messages[0]["content"] = messages[0]["content"].replace("<|vision_start|><|video_pad|><|vision_end|>", "<video>")
